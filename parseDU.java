...
//    System.out.println("Rooms inputted: " + roomList.size());
        ...
        // |_|/_/ \_\___/___/ |_|
        //
        // look at normal classroom, and then try the normal professor before finding a substitute
    ...
    for(ArrayList<Section> currentBucket : bucketList){ 
        ...
        while(it.hasNext()) {
            ...
            } //This ends the first pass: checking the normal classroom and then first the normal professor, then a substitute if needed
